...
<div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
  <div class="carousel-inner" style="height: 400px;">
    ...
    <div class="carousel-item ">
      <img class="d-block w-100 " style="object-fit: cover; object-position: center; height: 400px; overflow: hidden; filter:brightness(80%);" src="<?php echo Extras\get_foto_cursos_y_capacitaciones(); ?>" alt="">
      <div class="carousel-caption">
    ...
    <div class="carousel-item">
      <img class="d-block w-100 " style="object-fit: cover; object-position: center; height: 400px; overflow: hidden; filter:brightness(80%);" src="<?php echo Extras\get_foto_estadisticas(); ?>" alt="">
      <div class="carousel-caption">
    ...
    <div class="carousel-item">
      <img class="d-block w-100 " style="object-fit: cover; object-position: center; height: 400px; overflow: hidden; filter:brightness(80%);" src="<?php echo Extras\get_foto_controles(); ?>" alt="">
      <div class="carousel-caption">
        <h4><b>CONTROLES</b></h4>
    ...
    <div class="carousel-item ">
      <img class="d-block w-100 " style="object-fit: cover; object-position: center; height: 400px; overflow: hidden; filter:brightness(80%);" src="<?php echo Extras\get_foto_campanas(); ?>" alt="">
      <div class="carousel-caption">
        <h4><b>CAMPAÑAS</b></h4>
    ...
    <div class="carousel-item">
      <img class="d-block w-100 " style="object-fit: cover; object-position: center; height: 400px; overflow: hidden; filter:brightness(80%);" src="<?php echo Extras\get_foto_tramites(); ?>" alt="">
      <div class="carousel-caption">
        <h4><b>TRÁMITES</b></h4>
    ...
    <div class="carousel-item">
      <img class="d-block w-100 " style="object-fit: cover; object-position: center; height: 400px; overflow: hidden; filter:brightness(80%);" src="<?php echo Extras\get_foto_noticias(); ?>" alt="">
      <div class="carousel-caption">
        <h4><b>NOTICIAS</b></h4>
    ...
    <div class="carousel-item">
      <img class="d-block w-100 " style="object-fit: cover; object-position: center; height: 400px; overflow: hidden; filter:brightness(80%);" src="<?php echo Extras\get_foto_informe_de_transito(); ?>" alt="">
      <div class="carousel-caption">
